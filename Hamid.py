...
#The Credit For This Code Goes To hamidhacker
...
def login():
	...
	try:
		...
		print "\033[1;95m      тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАв\033[1;96mHamidhacker\033[1;95mтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд"
...
def pilih_super():
	...
	print "  \033[1;91m┬л---тАвтЧИтАв---Developed By hamid-hacker--тАвтЧИтАв---┬╗" #Dev:Hamid_hacker
